export default {
  ...
  portfolioUrl: 'https://drive.google.com/drive/folders/1bPFs7bmajs1ZfSVbEmOSRM-H2wGC5Ief?usp=sharing',
  ...
  projects: [
    ...
    { name: 'Keratin', client: 'Loreal', type: 'video', videoUrl: 'https://notreal-projects.s3.eu-north-1.amazonaws.com/NR_BlackApril_Loreal.mp4', preview: '/projects/NR_BlackApril_Loreal.webp', images: [] },
