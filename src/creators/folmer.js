export default {
  ...
  portfolioUrl: 'https://drive.google.com/drive/folders/19xensWHhRzIdHdZGtcS7mHLp7uhr6peC?usp=sharing',
  ...
  projects: [
    ...
    { name: 'Fly', client: 'Personal', type: 'video', videoUrl: 'https://notreal-projects.s3.eu-north-1.amazonaws.com/NR_Folmer_Fly.mp4', preview: '/projects/NR_Folmer_Fly.webp', images: [] },
  ]
};
